...
tellraw @a ["",{"selector":"@a[tag=turn]","bold":true,"color":"dark_aqua"},{"text":" rosted everyone ","color":"aqua"},{"text":"[","bold":true,"color":"dark_red"},{"text":"\ud83d\udde18","color":"red"},{"text":"]","bold":true,"color":"dark_red"}]
...
scoreboard players remove @a[tag=!turn,tag=game,team=!invulnerable] game.heal 8
